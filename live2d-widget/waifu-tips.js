...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["好久不见，日子过得好快呢……", "大笨蛋！你都多久没理人家了呀，嘤嘤嘤～", "嗨嗨嗨～快来逗我玩吧！", "呜呜呜，人家拿小拳拳锤你胸口！", "怎么不理我了啊～"];
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://www.playmarxcards.online/");
		});
		...
		window.addEventListener("visibilitychange", () => {
			if (!document.hidden) showMessage("哇呜，你终于回来了～", 6000, 9);
		});
	})();
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			else if (now > 19 && now <= 21) text = "要警惕站主打马克思牌！";
			else if (now > 21 && now <= 23) text = ["本年年度关键字：赢！", "我看啊，责任全在美方！！"];
			else text = "不敢高声语，恐惊天上人";
